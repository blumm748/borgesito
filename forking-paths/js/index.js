...
const fpDecoEl = document.querySelector('.fpDeco');
const images = [...fpDecoEl.querySelectorAll('.fpDeco__item')];
...
Promise.all([preloadImages('.fpDeco__item'), preloadFonts('ejh4sem')]).then(() => {
